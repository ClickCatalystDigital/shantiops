...
- **Open items:** client data questions + Excel row references + known app gaps (no Add-order, payments not editable, edits not audited) live in `docs/sales-tracker-data-issues.md`.
