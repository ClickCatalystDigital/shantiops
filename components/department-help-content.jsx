    ...
    features: [
      ...
      feature('remnant', 'Cutting & Remnant Matching', ScissorsIcon, [
        ...
        checklist: [
          ...
          'Release the BOM the normal way: Requests → Release BOM (its own tab in the Requests sidebar, also reachable from the BOMs workspace's own Release button) → pick the project → Release BOM. Matching runs automatically the instant you release — there is no separate step or button for it.',
      ...
      milestoneTrackerFeature([
        ...
        ['Release BOM / PR', 'Explicit action', 'Design or Engineering clicks "Release BOM" (its own tab in Requests, or the same action from the BOMs workspace), once the project actually has BOM items to release — this is also the moment Cutting & Remnant Matching checks every plate/section line against Stores.'],
  ...
  Engineering: {
    ...
    features: [
      ...
      feature('bomStructure', 'BOMs (assemblies)', LayersIcon, [
        ...
        'The project picker only shows unreleased projects by default (searchable — type to filter) — toggle "Show released too" to bring an already-released one back into the list; a project already open stays visible either way.',
