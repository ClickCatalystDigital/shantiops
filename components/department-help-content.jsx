  ...
  Sales: {
    ...
    features: [
      feature('enquiry', 'Enquiry', InboxIcon, [
        ...
        'Use it as your daily start-here queue; switch to the full Leads tab to see every stage, including Proposals, Hot Offers, Order Received and Order Lost.',
      ...
      feature('price-lists', 'Price Lists', TagIcon, [
        'Set a rate per product, either for one specific customer or as the default open to everyone — Sales → Price Lists → New Price, picked from the Product Master.',
        'When you pick a product on a quotation line, its price list rate fills in (the customer\'s own rate first, else the default), in place of the product\'s list price. Changing the customer re-checks every product line.',
