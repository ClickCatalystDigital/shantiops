...
export async function matchAndReserve(bomItem, username = 'system', byId = null, unitCount = null) {
  const req = parseDims(bomItem);
...
export async function matchProjectBom(projectId, username = 'system') {
  ...
  for (const item of items) {
    const r = await matchAndReserve(item, username, rollupById, unitCount);
