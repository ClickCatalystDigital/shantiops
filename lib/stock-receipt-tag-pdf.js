...
const s = StyleSheet.create({
  ...
  tRow: { flexDirection: 'row', borderBottomWidth: 1, borderLeftWidth: 1, borderColor: '#ddd', minHeight: 16 },
  cell: { paddingVertical: 4, paddingHorizontal: 4, borderRightWidth: 1, borderColor: '#ddd' },
});
