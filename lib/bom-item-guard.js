...
// 19 tables came back with a real FK (18 plus delivery_followups, added later for Procurement's
// Overdues follow-up log); `packing_items` is deliberately included too even though its
...
export const BOM_ITEM_BLOCKING_TABLES = [
  ...
  { table: 'inward_approvals', label: 'has an inward QC review on record' },
  { table: 'delivery_followups', label: 'has a delivery follow-up note logged' },
];
