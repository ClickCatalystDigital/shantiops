...
export const BOM_FIELD_OWNERS = {
  ...
  // received_* (Inventory Identity & Traceability, gap fix 2026-08-26) — captured at the same
  // moment as grn_ref, same owner, closing the free-text-GRN-path enforcement gap the PATCH route
  // now checks against requires_*.
  Stores: ['grn_ref', 'grn_qty_text', 'pending_qty_text', 'bqtc_ref', 'received_heat_no', 'received_mtc_no', 'received_supplier_batch_no', 'received_serial_no'],
