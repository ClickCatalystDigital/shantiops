...
// fmt(): plain vs currency-prefixed, and parenthesized negatives (accounting convention).
assert.strictEqual(fmt(41000), '41,000.00');
assert.strictEqual(fmt(41000, { currency: true }), 'Rs. 41,000.00');
assert.strictEqual(fmt(-100000), '(1,00,000.00)');
assert.strictEqual(fmt(-100000, { currency: true }), '(Rs. 1,00,000.00)');
