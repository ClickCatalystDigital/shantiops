  ...
  return (
    <Page size="A4" style={s.page}>
      ...
      <View style={{ fontSize: 10 }}>
        ...
        <KV label="Maker's Name" value={entity.name} filled labelWidth={65} />
...
function FormIIIPage({ document: d, entity, project, model, parts, mountingsPage, seams = [] }) {
  ...
  return [
    <Page key="iii-1" size="A4" style={s.page}>
      <Header entity={entity} />
      ...
      <View style={{ marginLeft: 20, fontSize: 10 }}>
        ...
        <KV label="Final Temp. of Steam (Superheater outlet)" value={d.steam_temp} filled tight style={s1Row} />
        <KV label="Brief Description of Boiler" value={d.boiler_type} filled tight style={s1Row} />
      </View>
      <Footer entity={entity} />
    </Page>,

    <Page key="iii-2" size="A4" style={s.page}>
      <Header entity={entity} />
      <ContdHeader />
      ...
      <Text style={{ fontSize: 8 }}>{d.parts_outside_constructor_works || 'NOT APPLICABLE'}</Text>
      <Footer entity={entity} />
    </Page>,

    <Page key="iii-3" size="A4" style={s.page}>
      <Header entity={entity} />
      <ContdHeader />
      ...
      <Text style={{ fontSize: 8 }}>{d.drums_details || 'Not Applicable'}</Text>
      <Footer entity={entity} />
    </Page>,

    <Page key="iii-4" size="A4" style={s.page}>
      <Header entity={entity} />
      <ContdHeader />
      <Text style={s.h}>6. Headers and Boxes</Text>
      <Text style={{ fontSize: 8 }}>{d.headers_boxes_details || 'Not Applicable'}</Text>
    ...
    <Page key="iii-5" size="A4" style={s.page}>
      <Header entity={entity} />
      <ContdHeader />
    ...
    switch (f) {
      ...
      case 'IVA': {
        ...
        if (!sectionPages.length) {
          return <FormTablePage key={f} document={d} entity={entity} cols={IVA_COLS} parts={ivaSections.ungrouped} preamble isLast />;
        }
        ...
        return sectionPages.map((p, i) => (
          <FormTablePage key={p.key} document={d} entity={entity} sectionLabel={p.sectionLabel} cols={IVA_COLS}
