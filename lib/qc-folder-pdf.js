...
function CoveringLetterPage({ document: d, project, entity, model, parts, mountings, pageRanges }) {
  ...
  return (
    <Page size="A4" style={s.page}>
      {/* Header/Footer suppressed on the cover letter (opacity:0 doesn't hide react-pdf's SVG logo/
          icons). The 38pt spacer matches Header's old flow height (32 logo + 6 margin) so the body
          starts where it always has; Footer was absolutely positioned, so it needs no spacer. */}
