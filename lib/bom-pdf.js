...
// Exported so app/api/projects/[id]/bom/xlsx/route.js can reuse the identical column set (Project
// View redesign, Wave 2's common BOM Excel export) — lib/reports/excel.js's toWorkbook() only ever
// reads the label/accessor/align entries, never the width%, so this one definition already serves
// both renderers, matching the Report Engine's own "one computed shape, several renderers" rule.
export const COLS = [
  ['#', 4, (it, i) => i + 1],
