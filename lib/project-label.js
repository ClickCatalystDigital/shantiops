...
export function projectLabel(it) {
  ...
  // Procurement's own custom-item add (no PMB/PR, no project picked) — same sentinel, same
  // "reads better than the literal placeholder" reasoning as sas/stock above.
  if (it.source === 'custom') return 'General';
