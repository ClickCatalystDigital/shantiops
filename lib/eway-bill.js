...
function getConfig() {
  ...
  if (!baseUrl || !publicKeyPem) {
    throw new Error('EWAY_BILL_BASE_URL and EWAY_BILL_PUBLIC_KEY are not both configured — these come from NIC at registration (Registration -> For API on the E-Way Bill portal), not something this app can supply. See SYSTEM.md §5ax.');
  }
