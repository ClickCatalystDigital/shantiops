...
const CATEGORY_PATTERNS = [
  ...
  ['other', /\bMCB\b|\bMCCB\b|CONTACTOR|\bRELAY\b|\bLED\b|\bLAMP\b|\bBUZZER\b|\bMETER\b|\bVOLT\b|\bCABLE\b|\bWIRE\b|\bLUG(S)?\b|TERMINAL|INSULATION TAPE|\bPANEL\b|\bPVC\b/],
  // Refractory/insulation/paint/consumables.
  ['other', /ASBESTOS|GLASS WOOL|CASTABLE|REFRACTORY|FIRE BRICK|INSULYTE|ACOSET|\bPAINT(S)?\b|THINNER|TERPENTOIL/],
  // Rotating/drive-train equipment.
  ['other', /\bMOTOR\b|\bPULLEY\b|PLUMMER BLOCK|\bBEARING(S)?\b|V['\s]?BELT|\bBELT\b/],
  ...
  // Raw dimensional shapes — checked last.
  ['plate', /\bPLATE(S)?\b|\bSHEET(S)?\b/],
