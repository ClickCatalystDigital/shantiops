...
const TOKEN_RE = /\b(JC|WO|NCR|BM|DG|CS|PR|RFQ|FA|PL|LN|SR|INV|INW|GIR|GP|PO|QT|SO|PK|CN|DN|SI|VB|IND)-[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*\b/gi;
...
export const ENTITY_TYPES = [
  ...
  { type: 'material_indent', label: 'Material Indent' },
];
