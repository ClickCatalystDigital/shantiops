...
export function isDesignHead(user) {
  return isPM(user) || (canAccessDepartment(user, 'Design') && departmentRole(user, 'Design') === 'head');
}
export function isDesignDesigner(user) {
  return canAccessDepartment(user, 'Design') && departmentRole(user, 'Design') === 'designer';
}
