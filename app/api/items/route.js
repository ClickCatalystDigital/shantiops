...
export async function GET(req) {
  ...
  const needle = `%${q}%`;
  // bom_category (2026-09, Item Master round) — the real, persisted shape-taxonomy default;
  // ItemSearchField uses it directly on pick now, replacing the old live group_name guess
