...
export async function POST(req) {
  ...
  for (const it of items) {
    ...
    await execute(
      `INSERT INTO bom_template_items (template_id, section, material_description, moc, size_spec, qty_text, sort_order, item_id, category, category_fields_json, named_parts_json)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
