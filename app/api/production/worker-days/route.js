// One row per worker per day: attendance + the single thing they worked on. Writes to HR's
// attendance_days (employee_id-keyed), not the frozen worker_days table — see
// PRODUCTION-MODULE-DESIGN.md §2.5. Upsert on the UNIQUE(employee_id, date) key so the card can
// just re-save itself on every change.
//
