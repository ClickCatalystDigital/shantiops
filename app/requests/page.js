...
export default async function RequestsPage() {
  ...
  // queue. The plain cross-department asks (no bom_item_id) now render as Outgoing/Incoming Incidents
  // on the Operations Procurement view (V2-CHANGES.md Group 4b), not here.
  ...
  return (
    <main className="container flex flex-col gap-6 py-8">
      <PageHeader title="Requests" description="New-item and cancel requests from other departments, waiting for Procurement to accept" />
      <RequestsWorkspace
        requests={requests}
